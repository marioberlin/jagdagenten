...
export {
  normalizeMessageToV0,
  normalizeMessageToV1,
} from './normalizer.js';

// Artifact normalization
export {
  normalizeArtifactToV0,
  normalizeArtifactToV1,
} from './normalizer.js';
...
export {
  normalizeAgentCardToV0,
  normalizeAgentCardToV1,
} from './normalizer.js';

// Method name normalization
export {
  normalizeMethodNameToV0,
  normalizeMethodNameToV1,
} from './normalizer.js';
