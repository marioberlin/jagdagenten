...
export function detectRequestVersion(
  ...
  if (headers) {
    const versionHeader =
      headers[A2A_HEADERS.PROTOCOL_VERSION] ||
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function detectPartVersion(part: any): ProtocolVersion {
 ...
 */
export function getProtocolVersionHeader(version: ProtocolVersion): string {
