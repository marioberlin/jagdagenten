...
export interface JSONRPCError {
  code: number;
  data?: JSONValue;
  message?: string;  // Made optional for compatibility with extending interfaces
}
...
export interface JSONRPCRequest<P = unknown> extends JSONRPCMessage {
  method: string;
  params?: P;
}
...
export interface GetTaskPushNotificationConfigRequest extends JSONRPCRequest<TaskIdParams | GetTaskPushNotificationConfigParams> {
  method: 'tasks/pushNotificationConfig/get';
  params: TaskIdParams | GetTaskPushNotificationConfigParams;
}

export interface ListTaskPushNotificationConfigRequest extends JSONRPCRequest<ListTaskPushNotificationConfigParams> {
  method: 'tasks/pushNotificationConfig/list';
  params: ListTaskPushNotificationConfigParams;
}

export interface DeleteTaskPushNotificationConfigRequest extends JSONRPCRequest<DeleteTaskPushNotificationConfigParams> {
  method: 'tasks/pushNotificationConfig/delete';
  params: DeleteTaskPushNotificationConfigParams;
}

export interface GetAuthenticatedExtendedCardRequest extends JSONRPCRequest<void> {
...
// Response Types
export interface SendMessageSuccessResponse extends JSONRPCSuccessResponse<Task | Message> {
  result: Task | Message;
}

export interface SendStreamingMessageSuccessResponse extends JSONRPCSuccessResponse<Task | Message | TaskStatusUpdateEvent | TaskArtifactUpdateEvent> {
  result: Task | Message | TaskStatusUpdateEvent | TaskArtifactUpdateEvent;
}

export interface GetTaskSuccessResponse extends JSONRPCSuccessResponse<Task> {
  result: Task;
}

export interface CancelTaskSuccessResponse extends JSONRPCSuccessResponse<Task> {
  result: Task;
}

export interface GetAuthenticatedExtendedCardSuccessResponse extends JSONRPCSuccessResponse<AgentCard> {
  result: AgentCard;
}

export interface GetTaskPushNotificationConfigSuccessResponse extends JSONRPCSuccessResponse<TaskPushNotificationConfig> {
  result: TaskPushNotificationConfig;
}

export interface ListTaskPushNotificationConfigSuccessResponse extends JSONRPCSuccessResponse<TaskPushNotificationConfig[]> {
  result: TaskPushNotificationConfig[];
}

export interface DeleteTaskPushNotificationConfigSuccessResponse extends JSONRPCSuccessResponse<null> {
  result: null;
}

export interface SetTaskPushNotificationConfigSuccessResponse extends JSONRPCSuccessResponse<TaskPushNotificationConfig> {
  result: TaskPushNotificationConfig;
}
...
// Union of all A2A-specific response types
