 ...
 */
export function normalizePartToV1(part) {
    switch (part.kind) {
        case 'text':
            return {
                text: part.text,
        ...
        case 'file': {
            ...
            const normalizedFile = 'bytes' in file
                ? {
                    bytes: file.bytes,
 ...
 */
export function normalizePartToV0(part) {
...
// ============================================================================
export function normalizeMessageToV1(message) {
    return {
...
export function normalizeMessageToV0(message) {
    return {
        kind: 'message',
...
// ============================================================================
export function normalizeArtifactToV1(artifact) {
    return {
...
export function normalizeArtifactToV0(artifact) {
    return {
...
// ============================================================================
export function normalizeStatusToV1(status) {
    return {
        state: status.state,
...
export function normalizeStatusToV0(status) {
    return {
        state: status.state,
...
// Task Normalization
// ============================================================================
export function normalizeTaskToV1(task) {
    return {
        id: task.id,
...
export function normalizeTaskToV0(task) {
    return {
        kind: 'task',
        id: task.id,
...
// Event Normalization
// ============================================================================
export function normalizeEventToV1(event) {
    ...
    if (event.kind === 'artifact-update') {
        ...
        if (event.append !== undefined)
            artifact.append = event.append;
        if (event.last_chunk !== undefined)
            artifact.lastChunk = event.last_chunk;
        return {
            taskId: event.task_id,
            contextId: event.context_id,
            artifact,
...
export function normalizeEventToV0(event) {
    if ('status' in event) {
        return {
            kind: 'status-update',
...
// ============================================================================
function normalizeSkillToV1(skill) {
    return {
        id: skill.id,
        name: skill.name,
...
function normalizeSkillToV0(skill) {
    return {
        id: skill.id,
        name: skill.name,
        description: skill.description,
...
function normalizeCapabilitiesToV1(caps) {
    return {
...
function normalizeCapabilitiesToV0(caps) {
    return {
        ...(caps.streaming !== undefined && { streaming: caps.streaming }),
...
export function normalizeAgentCardToV1(card) {
    // Security schemes need careful handling due to naming differences
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const securitySchemes = card.security_schemes;
    return {
        name: card.name,
        url: card.url,
...
export function normalizeAgentCardToV0(card) {
    // Security schemes need careful handling due to naming differences
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
const V1_TO_V0_METHODS = Object.fromEntries(Object.entries(V0_TO_V1_METHODS).map(([k, v]) => [v, k]));
export function normalizeMethodNameToV1(method) {
    return V0_TO_V1_METHODS[method] ?? method;
}
export function normalizeMethodNameToV0(method) {
...
// ============================================================================
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function normalizeRequestToV1(request) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function normalizeResponseToV0(response) {
