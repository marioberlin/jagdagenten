...
export const CURATED_AGENTS: CuratedAgent[] = [
    ...
    },
    {
        ...
        description: 'Real-time cryptocurrency market data from Binance. Get live prices, charts, order books, and market statistics.\n\n**What I can do:**\n• Fetch live prices for any crypto\n• Get OHLCV candlestick data\n• View order book depth\n• Find top gainers and losers\n\n**Try saying:** "BTC price" or "show all prices" or "ETH chart" or "top gainers"',
        shortDescription: 'Live crypto market data from Binance',
        url: 'http://127.0.0.1:3000/agents/market-data',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'market-data', 'binance', 'prices', 'charts'],
        featured: false,
        verified: true,
        rating: 4.8,
        reviewCount: 128,
    ...
    },
    {
        id: 'trade-executor',
        name: 'Trade Executor',
        description: 'Execute cryptocurrency trades with mock order management (TEST MODE). Place market/limit orders and track positions.\n\n**What I can do:**\n• Place buy/sell orders\n• Track open positions\n• Cancel pending orders\n• View order history\n\n**Try saying:** "buy 0.1 BTC" or "show positions" or "sell 0.5 ETH"',
        shortDescription: 'Mock trading execution & position tracking',
        url: 'http://127.0.0.1:3000/agents/trade-executor',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'orders', 'positions', 'execution'],
        featured: false,
        verified: true,
        rating: 4.7,
        reviewCount: 89,
    ...
    },
    {
        id: 'strategy',
        name: 'Strategy Agent',
        description: 'AI-powered trading signals using 8 technical indicators: RSI, MACD, MA Crossover, Bollinger Bands, Volume, ADX, Stochastic, ATR.\n\n**What I can do:**\n• Full technical analysis\n• Individual indicator checks\n• Trend direction analysis\n• Volatility assessment\n\n**Try saying:** "analyze BTC" or "RSI for ETH" or "SOL trend"',
        shortDescription: 'Technical analysis with 8 indicators',
        url: 'http://127.0.0.1:3000/agents/strategy',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'signals', 'technical-analysis', 'indicators'],
        featured: true,
        verified: true,
        rating: 4.9,
        reviewCount: 156,
    ...
    },
    {
        id: 'risk',
        name: 'Risk Agent',
        description: 'Manage trading risk with position limits, stop-loss/take-profit levels, and portfolio exposure monitoring.\n\n**What I can do:**\n• Assess trade risk\n• Calculate stop-loss levels\n• Calculate take-profit targets\n• Monitor portfolio exposure\n\n**Try saying:** "check risk 0.1 BTC" or "stop-loss for ETH" or "portfolio risk"',
        shortDescription: 'Risk management & position limits',
        url: 'http://127.0.0.1:3000/agents/risk',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'risk', 'stop-loss', 'portfolio'],
        featured: false,
        verified: true,
        rating: 4.6,
        reviewCount: 72,
    ...
    },
    {
        ...
        description: 'Your AI trading assistant that coordinates the complete workflow: market data → technical analysis → risk check → execution.\n\n**What I can do:**\n• Run full trading workflows\n• Scan for opportunities\n• Coordinate all trading agents\n• Auto-execute trades\n\n**Try saying:** "trade BTC" or "scan for opportunities" or "workflow status"',
        shortDescription: 'Automated trading workflow coordinator',
        url: 'http://127.0.0.1:3000/agents/orchestrator',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'automation', 'workflow', 'orchestration'],
        featured: true,
        verified: true,
        rating: 4.8,
        reviewCount: 203,
    ...
    },
    {
        ...
        description: 'Set up price alerts and receive trading notifications via email, Slack, Telegram, or in-app.\n\n**What I can do:**\n• Create price alerts (above/below)\n• Send notifications via multiple channels\n• Configure notification channels\n• View notification history\n\n**Try saying:** "alert when BTC above 100000" or "show my alerts" or "configure email"',
        shortDescription: 'Price alerts & multi-channel notifications',
        url: 'http://127.0.0.1:3000/agents/notification',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'alerts', 'notifications', 'email', 'slack'],
        featured: false,
        verified: true,
        rating: 4.6,
        reviewCount: 94,
    ...
    },
    {
        id: 'symbol-manager',
        name: 'Symbol Manager',
        description: 'Organize your crypto watchlists, mark favorites, and manage blacklisted tokens.\n\n**What I can do:**\n• Manage watchlists\n• Add/remove favorites\n• Blacklist unwanted tokens\n• Browse by category\n\n**Try saying:** "show watchlist" or "add SOL to watchlist" or "favorite BTC" or "show defi coins"',
        shortDescription: 'Watchlists, favorites & symbol organization',
        url: 'http://127.0.0.1:3000/agents/symbol-manager',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'watchlist', 'favorites', 'organization'],
        featured: false,
        verified: true,
        rating: 4.5,
        reviewCount: 67,
    ...
    },
    {
        ...
        description: 'Receive trading signals from TradingView, external APIs, and custom webhooks.\n\n**What I can do:**\n• Create webhook endpoints\n• Process TradingView alerts\n• View webhook history\n• Test webhooks\n\n**Try saying:** "create tradingview webhook" or "show webhooks" or "webhook history"',
        shortDescription: 'TradingView & custom webhook integration',
        url: 'http://127.0.0.1:3000/agents/webhook-gateway',
        version: '1.0.0',
        icon: Bitcoin,
        category: 'finance',
        tags: ['trading', 'webhooks', 'tradingview', 'signals'],
        featured: false,
        verified: true,
        rating: 4.7,
        reviewCount: 112,
    ...
    },
    {
        ...
        description: 'Monitor system health, run diagnostics, and perform maintenance tasks.\n\n**What I can do:**\n• System health checks\n• Performance metrics\n• Run cleanup tasks\n• Optimize caches\n\n**Try saying:** "health check" or "system stats" or "run cleanup"',
        shortDescription: 'System health, diagnostics & maintenance',
